    ...
    switch($_REQUEST['lType']) {
        case 'initiate':
            ...
            if(!$_GET['lResponse']) {
                ...
                header('Location: bravoojha.site90.com/Linkedin_Demo/profile_access.php?oauth_token='.$access['oauth_token'].'&oauth_token_secret='.$access['oauth_token_secret'].'&oauth_expires_in'.$access['oauth_expires_in'].'&oauth_authorization_expires_in='.$access['oauth_authorization_expires_in']);
                }
            }
        break;
    }
